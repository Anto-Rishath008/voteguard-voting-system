...
export default function RegisterPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Submit SIMPLIFIED registration data - only basic info
        ...
        <Card>
          <CardContent className="p-8">
            ...
            <div className="min-h-[400px] relative">
              ...
              {/* Steps 2-5: Blurred "Under Construction" */}
              {currentStep >= 2 && (
                <div className="space-y-6">
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-semibold text-gray-900">
                      {currentStep === 2 && "Contact & Verification"}
                      {currentStep === 3 && "ID Verification"}
                      {currentStep === 4 && "Security Questions"}
                      {currentStep === 5 && "Biometric & Final"}
                    </h3>
                  </div>
                  
                  {/* Blurred Preview of the step */}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm">
                    <div className="text-center p-8 bg-white rounded-lg shadow-lg border-2 border-dashed border-yellow-400 max-w-md">
                      <AlertTriangle className="h-16 w-16 text-yellow-500 mx-auto mb-4" />
                      <h3 className="text-2xl font-bold text-gray-900 mb-2">Under Construction</h3>
                      <p className="text-gray-600 mb-4">
                        Enhanced verification features are currently being developed.
                      </p>
                      <p className="text-sm text-gray-500">
                        For now, you can create an account with just basic information (Step 1).
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex justify-between pt-6 border-t">
              ...
              {currentStep === 1 ? (
                ...
                <>
                  ...
                  <Button
                    onClick={nextStep}
                    disabled={currentStep >= securityLevel.steps}
                    className="flex items-center"
                  >
                    Next
